...
//
//    fileprivate var _userGames: Dictionary<String, Game> = [:] {
//        didSet {
//            collectionView?.reloadSections(Section.userGames.indexSet)
//        }
//    }
//    fileprivate var _classicGames: Dictionary<String, Game> = [:] {
//        didSet {
//            collectionView?.reloadSections(Section.classicGames.indexSet)
//        }
//    }
//
//    fileprivate var _puzzles: [Puzzle] = [] {
//        didSet {
//            collectionView?.reloadSections(Section.puzzles.indexSet)
//        }
//    }
//}
//
...
//
//extension RootCollectionViewController: CloudObserver {
...
//        func _games(for key: String) -> Dictionary<String, Game> {
...
//            return games
//        }
//        _userGames = _games(for: "user-games")
//        _classicGames = _games(for: "classic-game")
//
//    }
//}
//
...
//        return IndexSet(integer: Section.all.index(of: self)!)
//    }
//
...
//        guard let cell = cell as? GameCell else { fatalError() }
//        return {
...
//    }
//
//    func configureGameCell(cell: UICollectionViewCell) -> (Playable) -> () {
//        guard let cell = cell as? GameCell else { fatalError("Expected a `ShowGameCell`") }
//        return { game in
...
//        let configuration = dataSource.headerConfiguration(for: indexPath)
...
//        let configuration = dataSource.cellConfiguration(for: indexPath)
